...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jystic$elm_font_awesome$FontAwesome_Internal$fromPath = F5(
		function (color, w, h, _p0, pathStr) {
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$width(widthStr),
						_elm_lang$svg$Svg_Attributes$height(heightStr),
						_elm_lang$svg$Svg_Attributes$viewBox(viewBoxStr)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$fill(colorStr),
								_elm_lang$svg$Svg_Attributes$d(pathStr)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]));
	...
	var _seanhess$elm_style$Style$background = function (b) {
		...
		var value$ = needsPrefix ? _elm_lang$core$Native_Utils.update(
			value,
			{
		...
		return {
			ctor: '_Tuple2',
			_0: 'background',
			_1: _seanhess$elm_style$Style$prefixValue(value$)
		};
	};
	var _seanhess$elm_style$Style$cursor = function (c) {
		var value = _seanhess$elm_style$Style$prefixSet(c);
		var value$ = _elm_lang$core$Native_Utils.eq(c, 'grab') ? _elm_lang$core$Native_Utils.update(
			value,
	...
	var _seanhess$elm_style$Style$display = function (d) {
		...
		var value$ = _elm_lang$core$Native_Utils.eq(d, 'flex') ? _elm_lang$core$Native_Utils.update(
			value,
	...
	var _seanhess$elm_style$Style$justifyContent = function (j) {
		...
		var value$ = _elm_lang$core$Native_Utils.eq(j, 'flex-start') ? _elm_lang$core$Native_Utils.update(
			value,
		...
		return A2(
			...
			_seanhess$elm_style$Style$prefixValue(value$));
	};
	var _seanhess$elm_style$Style$alignItems = function (a) {
		var value = _seanhess$elm_style$Style$prefixSet(a);
		var value$ = _elm_lang$core$Native_Utils.eq(a, 'flex-start') ? _elm_lang$core$Native_Utils.update(
			value,
	...
	var _seanhess$elm_style$Style$radialGradient = function (colors) {
		var colorString = A2(
			_elm_lang$core$String$join,
			',',
			A2(_elm_lang$core$List$map, _seanhess$elm_style$Style$color$, colors));
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'radial-gradient( ',
	...
	var _seanhess$elm_style$Style$right$ = 'right';
	var _seanhess$elm_style$Style$left$ = 'left';
	...
	var _seanhess$elm_style$Style$flex$ = 'flex';
	...
	var _user$project$Utils$createCmd = function (msg) {
		return A3(
	...
	var _user$project$Models$questionTypeToString = function (questionType) {
		var _p0 = questionType;
		switch (_p0.ctor) {
			case 'ShortAnswer':
				return 'ShortAnswer';
			case 'MediumAnswer':
	...
	var _user$project$Models$Model = F3(
		function (a, b, c) {
			return {title: a, questions: b, uid: c};
		});
	var _user$project$Models$Question = F4(
		function (a, b, c, d) {
			return {id: a, questionNumber: b, questionType: c, title: d};
		});
	var _user$project$Models$MultipleChoiceInfo = F2(
		function (a, b) {
			return {options: a, uid: b};
		});
	var _user$project$Models$Option = F2(
		function (a, b) {
			return {id: a, value: b};
		});
	var _user$project$Models$MultipleChoice = function (a) {
		return {ctor: 'MultipleChoice', _0: a};
	};
	var _user$project$Models$TrueFalse = {ctor: 'TrueFalse'};
	var _user$project$Models$LongAnswer = {ctor: 'LongAnswer'};
	var _user$project$Models$MediumAnswer = {ctor: 'MediumAnswer'};
	var _user$project$Models$ShortAnswer = {ctor: 'ShortAnswer'};
	var _user$project$Models$stringToQuestionType = function (string) {
		return _elm_lang$core$Native_Utils.eq(string, 'ShortAnswer') ? _user$project$Models$ShortAnswer : (_elm_lang$core$Native_Utils.eq(string, 'MediumAnswer') ? _user$project$Models$MediumAnswer : (_elm_lang$core$Native_Utils.eq(string, 'LongAnswer') ? _user$project$Models$LongAnswer : (_elm_lang$core$Native_Utils.eq(string, 'TrueFalse') ? _user$project$Models$TrueFalse : _user$project$Models$MultipleChoice(
			{
	...
	var _user$project$Messages$QuestionOrderingInfo = F2(
		function (a, b) {
			return {oldQuestionNumber: a, newQuestionNumber: b};
		});
	var _user$project$Messages$FormTitleUpdated = function (a) {
		return {ctor: 'FormTitleUpdated', _0: a};
	};
	var _user$project$Messages$QuestionOrderChanged = function (a) {
		return {ctor: 'QuestionOrderChanged', _0: a};
	};
	var _user$project$Messages$QuestionUpdated = F2(
		function (a, b) {
			return {ctor: 'QuestionUpdated', _0: a, _1: b};
		});
	var _user$project$Messages$QuestionRemoved = function (a) {
		return {ctor: 'QuestionRemoved', _0: a};
	};
	var _user$project$Messages$QuestionAdded = {ctor: 'QuestionAdded'};
	var _user$project$Messages$MultipleChoiceOptionUpdated = F2(
		function (a, b) {
			return {ctor: 'MultipleChoiceOptionUpdated', _0: a, _1: b};
		});
	var _user$project$Messages$MultipleChoiceOptionRemoved = function (a) {
		return {ctor: 'MultipleChoiceOptionRemoved', _0: a};
	};
	var _user$project$Messages$MultipleChoiceOptionAdded = {ctor: 'MultipleChoiceOptionAdded'};
	var _user$project$Messages$TitleUpdated = function (a) {
		return {ctor: 'TitleUpdated', _0: a};
	};
	var _user$project$Messages$TypeChanged = function (a) {
		return {ctor: 'TypeChanged', _0: a};
	};

	var _user$project$Views_Styling$standardPadding = _seanhess$elm_style$Style$px(8);
	var _user$project$Views_Styling$centeredText = _elm_lang$core$Native_List.fromArray(
		[
			_seanhess$elm_style$Style$textAlign(_seanhess$elm_style$Style$center)
		]);
	var _user$project$Views_Styling$horizontalCenteredLayout = _elm_lang$core$Native_List.fromArray(
		[
			_seanhess$elm_style$Style$display(_seanhess$elm_style$Style$flex$)
		]);
	var _user$project$Views_Styling$globalStyles = _elm_lang$core$Native_List.fromArray(
		[
			_seanhess$elm_style$Style$fontFamily('Helvetica')
		]);
	var _user$project$Views_Styling$writtenQuestionInput = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
			{ctor: '_Tuple2', _0: 'resize', _1: 'none'},
			_seanhess$elm_style$Style$width(
			_seanhess$elm_style$Style$pc(100))
		]);
	var _user$project$Views_Styling$questionStyle = _elm_lang$core$Native_List.fromArray(
		[
			_seanhess$elm_style$Style$paddingBottom(_user$project$Views_Styling$standardPadding),
			_seanhess$elm_style$Style$paddingTop(_user$project$Views_Styling$standardPadding)
		]);
	var _user$project$Views_Styling$svgContainer = _elm_lang$core$Native_List.fromArray(
		[
			_seanhess$elm_style$Style$display(_seanhess$elm_style$Style$inlineBlock),
			_seanhess$elm_style$Style$verticalAlign('middle')
		]);
	var _user$project$Views_Styling$panelHeading = _user$project$Views_Styling$centeredText;
	var _user$project$Views_Styling$columnSpacer = _elm_lang$core$Native_List.fromArray(
		[
			_seanhess$elm_style$Style$flexGrow('1')
		]);
	var _user$project$Views_Styling$mainPanel = _elm_lang$core$Native_List.fromArray(
		[
			_seanhess$elm_style$Style$paddingLeft(_user$project$Views_Styling$standardPadding),
			_seanhess$elm_style$Style$paddingRight(_user$project$Views_Styling$standardPadding),
			_seanhess$elm_style$Style$paddingBottom(_user$project$Views_Styling$standardPadding),
			_seanhess$elm_style$Style$flexGrow('5'),
			_seanhess$elm_style$Style$minWidth(
			_seanhess$elm_style$Style$px(300)),
			_seanhess$elm_style$Style$borderColor(
			_seanhess$elm_style$Style$color$(_elm_lang$core$Color$green)),
			_seanhess$elm_style$Style$borderWidth(
			_seanhess$elm_style$Style$px(5)),
			_seanhess$elm_style$Style$borderRadius(
			_seanhess$elm_style$Style$px(10)),
			_seanhess$elm_style$Style$borderStyle('solid')
		]);
	var _user$project$Views_Styling$mainContainer = _elm_lang$core$List$concat(
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Views_Styling$horizontalCenteredLayout, _user$project$Views_Styling$globalStyles]));

	var _user$project$Views_Resources$fontIconContainer = F2(
		function (msg, icon) {
			return A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$svgContainer),
						_elm_lang$html$Html_Events$onClick(msg)
					]),
				_elm_lang$core$Native_List.fromArray(
					[icon]));
		});
	var _user$project$Views_Resources$downButton = function (msg) {
		return A2(
			_user$project$Views_Resources$fontIconContainer,
			msg,
			A2(_jystic$elm_font_awesome$FontAwesome$arrow_down, _elm_lang$core$Color$black, 18));
	};
	var _user$project$Views_Resources$upButton = function (msg) {
		return A2(
			_user$project$Views_Resources$fontIconContainer,
			msg,
			A2(_jystic$elm_font_awesome$FontAwesome$arrow_up, _elm_lang$core$Color$black, 18));
	};
	var _user$project$Views_Resources$removeButton = function (msg) {
		return A2(
			_user$project$Views_Resources$fontIconContainer,
			msg,
			A2(_jystic$elm_font_awesome$FontAwesome$close, _elm_lang$core$Color$red, 18));
	};
	var _user$project$Views_Resources$optionPlaceholder = 'Option X';
	var _user$project$Views_Resources$questionPlaceholder = 'What do you want to ask?';

	var _user$project$Views_QuestionOutput$renderMultipleChoiceOutput = F2(
		function (id, option) {
			return A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$value(option.value)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text(
						_elm_lang$core$String$isEmpty(option.value) ? _user$project$Views_Resources$optionPlaceholder : option.value)
					]));
		});
	var _user$project$Views_QuestionOutput$questionSpecificContent = function (_p0) {
		var _p1 = _p0;
		var _p3 = _p1.id;
		var _p2 = _p1.questionType;
		switch (_p2.ctor) {
			case 'ShortAnswer':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$writtenQuestionInput),
							_elm_lang$html$Html_Attributes$rows(1),
							_elm_lang$html$Html_Attributes$placeholder('A few words expected')
						]),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'MediumAnswer':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Attributes$placeholder('A couple of sentences expected')
						]),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'LongAnswer':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$writtenQuestionInput),
							_elm_lang$html$Html_Attributes$rows(8),
							_elm_lang$html$Html_Attributes$placeholder('A paragraph expected')
						]),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'TrueFalse':
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Views_QuestionOutput$renderMultipleChoiceOutput(_p3),
						_elm_lang$core$Native_List.fromArray(
							[
								{value: 'True'},
								{value: 'False'}
	...
	var _user$project$Views_QuestionOutput$renderQuestionOutput = function (_p4) {
		var _p5 = _p4;
		var _p6 = _p5.title;
		var title$ = _elm_lang$core$String$isEmpty(_p6) ? _user$project$Views_Resources$questionPlaceholder : _p6;
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$questionStyle)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(_p5.questionNumber),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Views_QuestionOutput$questionSpecificContent(_p5)
						]))
				]));
	};

	var _user$project$Views_WorksheetOutput$renderOutputWith = F2(
		function (htmlElem, question) {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Views_QuestionOutput$renderQuestionOutput(question),
						htmlElem
					]));
		});
	var _user$project$Views_WorksheetOutput$renderOutput = F3(
		function (listLength, currentIndex, question) {
			return _elm_lang$core$Native_Utils.eq(listLength - 1, currentIndex) ? A2(
				_user$project$Views_WorksheetOutput$renderOutputWith,
				_elm_lang$html$Html$text(''),
				question) : A2(
				_user$project$Views_WorksheetOutput$renderOutputWith,
				A2(
	...
	var _user$project$Views_WorksheetOutput$renderWorksheetOutput = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$panelHeading)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					A2(
						...
						_user$project$Views_WorksheetOutput$renderOutput(
							_elm_lang$core$List$length(model.questions)),
						model.questions))
				]));
	};

	var _user$project$Views_QuestionSpecificControl$renderOption = F2(
		function (questionId, option) {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$placeholder(_user$project$Views_Resources$optionPlaceholder),
								_elm_lang$html$Html_Events$onInput(
								function (_p0) {
									return A2(
										_user$project$Messages$QuestionUpdated,
										questionId,
										A2(_user$project$Messages$MultipleChoiceOptionUpdated, option.id, _p0));
								}),
								_elm_lang$html$Html_Attributes$value(option.value)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(option.value)
							])),
						_user$project$Views_Resources$removeButton(
						A2(
							_user$project$Messages$QuestionUpdated,
							questionId,
							_user$project$Messages$MultipleChoiceOptionRemoved(option.id)))
					]));
		});
	var _user$project$Views_QuestionSpecificControl$renderQuestionSpecificControl = function (_p1) {
		var _p2 = _p1;
		var _p4 = _p2.id;
		var _p3 = _p2.questionType;
		if (_p3.ctor === 'MultipleChoice') {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$List$concat(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_elm_lang$core$List$map,
							_user$project$Views_QuestionSpecificControl$renderOption(_p4),
							_p3._0.options),
							_elm_lang$core$Native_List.fromArray(
							[
								A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												A2(_user$project$Messages$QuestionUpdated, _p4, _user$project$Messages$MultipleChoiceOptionAdded))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Add option')
											]))
									]))
							])
						])));
	...
	var _user$project$Views_WorksheetControls$prettyPrint = function (questionType) {
		var _p0 = questionType;
		switch (_p0.ctor) {
			case 'ShortAnswer':
				return 'Short answer';
	...
	var _user$project$Views_WorksheetControls$renderQuestionType = function (questionType) {
		return A2(
			_elm_lang$html$Html$option,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$value(
					_user$project$Models$questionTypeToString(questionType))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(
					_user$project$Views_WorksheetControls$prettyPrint(questionType))
				]));
	};
	var _user$project$Views_WorksheetControls$renderQuestionTypes = A2(
		_elm_lang$core$List$map,
		_user$project$Views_WorksheetControls$renderQuestionType,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Models$ShortAnswer,
				_user$project$Models$MediumAnswer,
				_user$project$Models$LongAnswer,
				_user$project$Models$TrueFalse,
				_user$project$Models$MultipleChoice(
				{
					options: _elm_lang$core$Native_List.fromArray(
						[]),
					uid: 0
	...
	var _user$project$Views_WorksheetControls$questionTypeChanged = F2(
		function (id, string) {
			return A2(
				_user$project$Messages$QuestionUpdated,
				id,
				_user$project$Messages$TypeChanged(
					_user$project$Models$stringToQuestionType(string)));
		});
	var _user$project$Views_WorksheetControls$renderControl = F3(
		function (listLength, index, _p1) {
			var _p2 = _p1;
			var _p6 = _p2.title;
			var _p5 = _p2.questionNumber;
			var _p4 = _p2.id;
			var isLastElement = _elm_lang$core$Native_Utils.eq(index, listLength - 1);
			var isFirstElement = _elm_lang$core$Native_Utils.eq(index, 0);
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$placeholder(_user$project$Views_Resources$questionPlaceholder),
								_elm_lang$html$Html_Events$onInput(
								function (_p3) {
									return A2(
										_user$project$Messages$QuestionUpdated,
										_p4,
										_user$project$Messages$TitleUpdated(_p3));
								}),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onInput(
								_user$project$Views_WorksheetControls$questionTypeChanged(_p4)),
								_elm_lang$html$Html_Attributes$value(
								_user$project$Models$questionTypeToString(_p2.questionType))
							]),
						_user$project$Views_WorksheetControls$renderQuestionTypes),
						isFirstElement ? _elm_lang$html$Html$text('') : _user$project$Views_Resources$upButton(
						_user$project$Messages$QuestionOrderChanged(
							{oldQuestionNumber: _p5, newQuestionNumber: _p5 - 1})),
						isLastElement ? _elm_lang$html$Html$text('') : _user$project$Views_Resources$downButton(
						_user$project$Messages$QuestionOrderChanged(
							{oldQuestionNumber: _p5, newQuestionNumber: _p5 + 1})),
						_user$project$Views_Resources$removeButton(
						_user$project$Messages$QuestionRemoved(_p4)),
						_user$project$Views_QuestionSpecificControl$renderQuestionSpecificControl(_p2)
					]));
		});
	var _user$project$Views_WorksheetControls$targetTextContent = A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['target', 'textContent']),
		_elm_lang$core$Json_Decode$string);
	var _user$project$Views_WorksheetControls$renderWorksheetControls = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$on,
							'blur',
							A2(_elm_lang$core$Json_Decode$map, _user$project$Messages$FormTitleUpdated, _user$project$Views_WorksheetControls$targetTextContent)),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								_elm_lang$core$List$indexedMap,
								_user$project$Views_WorksheetControls$renderControl(
									_elm_lang$core$List$length(model.questions)),
								model.questions)),
							A2(
							_elm_lang$html$Html$button,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onClick(_user$project$Messages$QuestionAdded)
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Add question')
								]))
						]))
				]));
	};
	...
	var _user$project$Views$view = function (model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$mainContainer)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$columnSpacer)
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$Views_Styling$mainPanel)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Views_WorksheetControls$renderWorksheetControls(model)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Views_WorksheetOutput$renderWorksheetOutput(model)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
	...
	var _user$project$Main$updateListItem = F3(
		function (updateFunction, id, item) {
			return _elm_lang$core$Native_Utils.eq(item.id, id) ? updateFunction(item) : item;
		});
	var _user$project$Main$updateMultipleChoiceInfo = F2(
		function (updateFunction, questionId) {
			var updateChoiceInfo = function (question) {
				var _p0 = question;
				if (_p0.ctor === 'MultipleChoice') {
					return _user$project$Models$MultipleChoice(
						updateFunction(_p0._0));
				} else {
					return question;
				}
			};
			return A2(
				_user$project$Main$updateListItem,
				function (q) {
					return _elm_lang$core$Native_Utils.update(
						q,
						{
							questionType: updateChoiceInfo(q.questionType)
						});
				},
				questionId);
		});
	var _user$project$Main$updateMultipleChoiceOption = F3(
		function (questionId, optionId, newValue) {
			...
			var updateOptions = function (options) {
				return A2(
					_elm_lang$core$List$map,
					A2(_user$project$Main$updateListItem, updateOption, optionId),
					options);
			};
			return A2(
				_user$project$Main$updateMultipleChoiceInfo,
				function (x) {
					return _elm_lang$core$Native_Utils.update(
						x,
						{
							options: updateOptions(x.options)
						});
				},
				questionId);
		});
	var _user$project$Main$removeMultipleChoiceOption = F2(
		function (questionId, optionId) {
			var removeOption = function (info) {
				return _elm_lang$core$Native_Utils.update(
					info,
					{
						options: A2(
							...
							function (o) {
								return !_elm_lang$core$Native_Utils.eq(o.id, optionId);
							},
							info.options)
					});
			};
			return A2(_user$project$Main$updateMultipleChoiceInfo, removeOption, questionId);
		});
	var _user$project$Main$addMultipleChoiceOption = function (id) {
		return A2(
			_user$project$Main$updateMultipleChoiceInfo,
			function (_p1) {
				var _p2 = _p1;
	...
	var _user$project$Main$updateQuestionType = F2(
		function (newType, id) {
			return A2(
				_user$project$Main$updateListItem,
				function (q) {
	...
	var _user$project$Main$updateQuestionTitle = F2(
	...
	var _user$project$Main$moveQuestion = F2(
		function (_p4, questions) {
			var _p5 = _p4;
			var _p11 = _p5.oldQuestionNumber;
			var _p10 = _p5.newQuestionNumber;
			var questionHasMovedUp = _elm_lang$core$Native_Utils.cmp(_p10, _p11) < 0;
			var questionAffectedByMove = function (questionNumber) {
				return questionHasMovedUp ? ((_elm_lang$core$Native_Utils.cmp(_p11, questionNumber) > 0) && (_elm_lang$core$Native_Utils.cmp(questionNumber, _p10) > -1)) : ((_elm_lang$core$Native_Utils.cmp(_p10, questionNumber) > -1) && (_elm_lang$core$Native_Utils.cmp(questionNumber, _p11) > 0));
			};
			var reorderQuestion = function (_p6) {
				var _p7 = _p6;
				var _p9 = _p7.questionNumber;
				var _p8 = _p7;
				return _elm_lang$core$Native_Utils.eq(_p9, _p11) ? _elm_lang$core$Native_Utils.update(
					_p8,
					{questionNumber: _p10}) : (questionAffectedByMove(_p9) ? (questionHasMovedUp ? _elm_lang$core$Native_Utils.update(
					_p8,
					{questionNumber: _p9 + 1}) : _elm_lang$core$Native_Utils.update(
					_p8,
					{questionNumber: _p9 - 1})) : _p8);
			};
			return A2(
				...
				A2(_elm_lang$core$List$map, reorderQuestion, questions));
		});
	var _user$project$Main$renumberQuestions = function () {
		var numberQuestion = F2(
			function (index, question) {
				return _elm_lang$core$Native_Utils.update(
					question,
					{questionNumber: index + 1});
			});
		return _elm_lang$core$List$indexedMap(numberQuestion);
	}();
	var _user$project$Main$update = F2(
		function (msg, _p12) {
			var _p13 = _p12;
			var _p21 = _p13.uid;
			var _p20 = _p13.questions;
			var _p19 = _p13;
			var _p14 = msg;
			switch (_p14.ctor) {
				case 'FormTitleUpdated':
					return {
						ctor: '_Tuple2',
								...
								questions: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											{
											id: _p21,
											questionType: _user$project$Models$ShortAnswer,
											title: '',
											questionNumber: _elm_lang$core$List$length(_p20) + 1
										}
										])),
								uid: _p21 + 1
							}),
				...
				case 'QuestionRemoved':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							_p19,
							{
								questions: _user$project$Main$renumberQuestions(
									A2(
										_elm_lang$core$List$filter,
										function (q) {
											return !_elm_lang$core$Native_Utils.eq(q.id, _p14._0);
										},
										_p20))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'QuestionOrderChanged':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							_p19,
							{
								questions: A2(_user$project$Main$moveQuestion, _p14._0, _p20)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
					...
					switch (_p15.ctor) {
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									_p19,
									{
										questions: A2(
											_elm_lang$core$List$map,
											A2(_user$project$Main$updateQuestionTitle, _p15._0, _p18),
											_p20)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						case 'TypeChanged':
							var _p17 = _p15._0;
							var addOptionIfMultipleChoice = function (questionType) {
								var _p16 = questionType;
								if (_p16.ctor === 'MultipleChoice') {
									return _user$project$Utils$createCmd(
										A2(_user$project$Messages$QuestionUpdated, _p18, _user$project$Messages$MultipleChoiceOptionAdded));
								} else {
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									_p19,
									{
										questions: A2(
											_elm_lang$core$List$map,
											A2(_user$project$Main$updateQuestionType, _p17, _p18),
											_p20)
									}),
								_1: addOptionIfMultipleChoice(_p17)
							};
						case 'MultipleChoiceOptionAdded':
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									_p19,
									{
										questions: A2(
											_elm_lang$core$List$map,
											_user$project$Main$addMultipleChoiceOption(_p18),
											_p20)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						case 'MultipleChoiceOptionRemoved':
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									_p19,
									{
										questions: A2(
											_elm_lang$core$List$map,
											A2(_user$project$Main$removeMultipleChoiceOption, _p18, _p15._0),
											_p20)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									_p19,
									{
										questions: A2(
											_elm_lang$core$List$map,
											A3(_user$project$Main$updateMultipleChoiceOption, _p18, _p15._0, _p15._1),
											_p20)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
